...
import controller.RelatorioSalasMaisReservadasController;
...
public class RelatorioSalasMaisReservadasView extends JFrame {

    private final RelatorioSalasMaisReservadasController controller = new RelatorioSalasMaisReservadasController();
    ...
    private JScrollPane criarTabela() {
        String[] colunas = {"Período", "Código da Sala", "Total de Reservas"};
